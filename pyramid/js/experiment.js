$(function(){
	...
	// test - chrome passes all tests but still renders incorrectly
	/*
ok = function(d,tst){
			var i = 0;
			for(i; i < tst.length; i++) {
				if(typeof d.style[tst[i]] === "undefined") {
					return false;
				}
			}
			return true;
		}(document.documentElement, ['WebkitTransform', 'WebkitTransition', 'WebkitPerspective', 'WebkitTransformStyle', 'WebkitPerspectiveOrigin']);
*/
